...
void Texture::SetupTexture(unsigned char* image)
{
	glGenTexturesEXT(1, &m_RendererID);
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, m_Width, m_Height, 0, GL_RGBA, GL_UNSIGNED_BYTE, &image[0]);
}
